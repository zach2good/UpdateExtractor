    text =
    {
        ...
        PLAYER_OBTAINS_ITEM              = 8625,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM            = 8626,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM         = 8627,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP             = 8628,  -- You already possess that temporary item.
        NO_COMBINATION                   = 8633,  -- You were unable to enter a combination.
        REGIME_REGISTERED                = 10711, -- New training regime registered!
        COMMON_SENSE_SURVIVAL            = 11768, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
