    text =
    {
        ...
        SENSE_SOMETHING_EVIL     = 7310,  -- You sense something evil.
        HEAVY_DOOR               = 7311,  -- It is a solid stone door.
        PLAYER_OBTAINS_ITEM      = 8249,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM    = 8250,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM = 8251,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP     = 8252,  -- You already possess that temporary item.
        NO_COMBINATION           = 8257,  -- You were unable to enter a combination.
