    text =
    {
        ...
        PLACED_INTO_THE_PEDESTAL         = 7622, -- It appears that something should be placed into this pedestal.
        YOU_PLACE_THE                    = 7623, -- You place the <item> into the pedestal.
        IS_SET_IN_THE_PEDESTAL           = 7624, -- The <item> is set in the pedestal.
        HAS_LOST_ITS_POWER               = 7625, -- The <item> has lost its power.
