    text =
    {
        ...
        SOMETHING_BURRIED          = 7312,  -- It looks like something was buried here.
        ...
        REGIME_REGISTERED          = 9688,  -- New training regime registered!
        COMMON_SENSE_SURVIVAL      = 10807, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
